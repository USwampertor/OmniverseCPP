...
//
#ifndef PHYSXSCHEMA_GENERATED_PHYSXVEHICLECLUTCHAPI_H
#define PHYSXSCHEMA_GENERATED_PHYSXVEHICLECLUTCHAPI_H
...
public:
    ...
    /// an invalid \p prim
    explicit PhysxSchemaPhysxVehicleClutchAPI(const UsdPrim& prim=UsdPrim())
    ...
    explicit PhysxSchemaPhysxVehicleClutchAPI(const UsdSchemaBase& schemaObj)
    ...
    ///
    PHYSXSCHEMA_API
    static PhysxSchemaPhysxVehicleClutchAPI
...
public:
    ...
    // STRENGTH 
    // --------------------------------------------------------------------- //
    /// Strength of clutch (default unit is kilograms meters-squared per second [kg m^2 s^-1]).

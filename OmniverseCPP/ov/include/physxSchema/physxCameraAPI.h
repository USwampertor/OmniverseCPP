...
//
#ifndef PHYSXSCHEMA_GENERATED_PHYSXCAMERAAPI_H
#define PHYSXSCHEMA_GENERATED_PHYSXCAMERAAPI_H
...
public:
    ...
    /// an invalid \p prim
    explicit PhysxSchemaPhysxCameraAPI(const UsdPrim& prim=UsdPrim())
    ...
    explicit PhysxSchemaPhysxCameraAPI(const UsdSchemaBase& schemaObj)
    ...
    ///
    PHYSXSCHEMA_API
    static PhysxSchemaPhysxCameraAPI

...
public:
    ...
    // --------------------------------------------------------------------- //
    /// The mass-normalized kinetic energy threshold below which an articulation may participate in stabilization. Allowed range [0, max_float). Default value 0.00005*tolerancesSpeed*tolerancesSpeed.
    ///
    /// | ||
    /// | -- | -- |

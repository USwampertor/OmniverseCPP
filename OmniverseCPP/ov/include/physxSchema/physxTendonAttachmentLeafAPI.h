...
///
class PhysxSchemaPhysxTendonAttachmentLeafAPI : public PhysxSchemaPhysxTendonAttachmentAPI
{
public:
    ...
    explicit PhysxSchemaPhysxTendonAttachmentLeafAPI(
        ...
        : PhysxSchemaPhysxTendonAttachmentAPI(prim, /*instanceName*/ name)
    { }
    ...
    explicit PhysxSchemaPhysxTendonAttachmentLeafAPI(
        ...
        : PhysxSchemaPhysxTendonAttachmentAPI(schemaObj, /*instanceName*/ name)
    { }
...
public:
    ...
    // RESTLENGTH 
    // --------------------------------------------------------------------- //
    /// Sub-tendon rest length. Range [0, inf). If set to a negative value, the rest length is computed internally from the articulation pose and the attachment positions at simulation start.
    /// Units: distance
    ///
    /// | ||
    /// | -- | -- |
...
public:
    ...
    // LOWERLIMIT 
    // --------------------------------------------------------------------- //
    /// Sub-tendon length lower limit. Range (-inf, upperLimit].
    /// Units: distance
    ///
    /// | ||
    /// | -- | -- |
...
public:
    ...
    // UPPERLIMIT 
    // --------------------------------------------------------------------- //
    /// Sub-tendon length upper limit. Range [lowerLimit, inf).
    /// Units: distance
    ///
    /// | ||
    /// | -- | -- |

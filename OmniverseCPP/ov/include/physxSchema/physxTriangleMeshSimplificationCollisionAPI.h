...
//
#ifndef PHYSXSCHEMA_GENERATED_PHYSXTRIANGLEMESHSIMPLIFICATIONCOLLISIONAPI_H
#define PHYSXSCHEMA_GENERATED_PHYSXTRIANGLEMESHSIMPLIFICATIONCOLLISIONAPI_H
...
public:
    ...
    ///
    PHYSXSCHEMA_API
    static PhysxSchemaPhysxTriangleMeshSimplificationCollisionAPI

...
//
#ifndef PHYSXSCHEMA_GENERATED_PHYSXVEHICLEDRIVEBASICAPI_H
#define PHYSXSCHEMA_GENERATED_PHYSXVEHICLEDRIVEBASICAPI_H
...
public:
    ...
    /// an invalid \p prim
    explicit PhysxSchemaPhysxVehicleDriveBasicAPI(const UsdPrim& prim=UsdPrim())
    ...
    explicit PhysxSchemaPhysxVehicleDriveBasicAPI(const UsdSchemaBase& schemaObj)
    ...
    ///
    PHYSXSCHEMA_API
    static PhysxSchemaPhysxVehicleDriveBasicAPI
...
public:
    ...
    // PEAKTORQUE 
    // --------------------------------------------------------------------- //
    /// Maximum torque to apply to the wheels when the accelerator pedal is at maximum
    ...
    /// | ||
    /// | -- | -- |
    /// | Declaration | `float physxVehicleDriveBasic:peakTorque` |
    /// | C++ Type | float |

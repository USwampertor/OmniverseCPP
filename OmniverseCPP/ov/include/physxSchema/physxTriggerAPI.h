...
public:
    ...
    /// an invalid \p prim
    explicit PhysxSchemaPhysxTriggerAPI(const UsdPrim& prim=UsdPrim())
    ...
    explicit PhysxSchemaPhysxTriggerAPI(const UsdSchemaBase& schemaObj)
    ...
    /// Return a PhysxSchemaPhysxTriggerAPI holding the prim adhering to this
    /// schema at \p path on \p stage.  If no prim exists at \p path on
    /// \p stage, or if the prim at that path does not adhere to this schema,
    /// return an invalid schema object.  This is shorthand for the following:
    ///
    /// \code
    /// PhysxSchemaPhysxTriggerAPI(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    PHYSXSCHEMA_API
    static PhysxSchemaPhysxTriggerAPI
...
public:
    ...
    // ENTERSCRIPTTYPE 
    // --------------------------------------------------------------------- //
    /// Enter script type. Script file tries to find a file on disc and execute. Script buffer does execute the provided script string directly.
    ///
    /// | ||
    /// | -- | -- |
...
public:
    ...
    // LEAVESCRIPTTYPE 
    // --------------------------------------------------------------------- //
    /// Leave script type. Script file tries to find a file on disc and execute. Script buffer does execute the provided script string directly.
    ///
    /// | ||
    /// | -- | -- |
...
public:
    ...
    PHYSXSCHEMA_API
    static bool UnapplyAPISchema(UsdPrim &prim, bool removeAttributes = true);
};

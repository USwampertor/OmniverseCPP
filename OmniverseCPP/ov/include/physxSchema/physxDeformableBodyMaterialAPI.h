...
///
/// Applied to USD Material. Defines material properties for deformable bodies. See PhysxDeformableAPI for more information on how to bind a material to the entire collision tetrahedral mesh, or multiple materials to UsdGeomSubsets of the mesh.
///

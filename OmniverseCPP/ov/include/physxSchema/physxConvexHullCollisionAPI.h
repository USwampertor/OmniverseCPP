...
//
#ifndef PHYSXSCHEMA_GENERATED_PHYSXCONVEXHULLCOLLISIONAPI_H
#define PHYSXSCHEMA_GENERATED_PHYSXCONVEXHULLCOLLISIONAPI_H
...
public:
    ...
    /// an invalid \p prim
    explicit PhysxSchemaPhysxConvexHullCollisionAPI(const UsdPrim& prim=UsdPrim())
    ...
    explicit PhysxSchemaPhysxConvexHullCollisionAPI(const UsdSchemaBase& schemaObj)
    ...
    /// Return a PhysxSchemaPhysxConvexHullCollisionAPI holding the prim adhering to this
    /// schema at \p path on \p stage.  If no prim exists at \p path on
    /// \p stage, or if the prim at that path does not adhere to this schema,
    /// return an invalid schema object.  This is shorthand for the following:
    ///
    /// \code
    /// PhysxSchemaPhysxConvexHullCollisionAPI(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    PHYSXSCHEMA_API
    static PhysxSchemaPhysxConvexHullCollisionAPI

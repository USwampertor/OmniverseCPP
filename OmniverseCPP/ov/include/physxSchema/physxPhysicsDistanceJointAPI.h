...
//
#ifndef PHYSXSCHEMA_GENERATED_PHYSXPHYSICSDISTANCEJOINTAPI_H
#define PHYSXSCHEMA_GENERATED_PHYSXPHYSICSDISTANCEJOINTAPI_H
...
public:
    ...
    /// an invalid \p prim
    explicit PhysxSchemaPhysxPhysicsDistanceJointAPI(const UsdPrim& prim=UsdPrim())
    ...
    explicit PhysxSchemaPhysxPhysicsDistanceJointAPI(const UsdSchemaBase& schemaObj)
    ...
    ///
    PHYSXSCHEMA_API
    static PhysxSchemaPhysxPhysicsDistanceJointAPI

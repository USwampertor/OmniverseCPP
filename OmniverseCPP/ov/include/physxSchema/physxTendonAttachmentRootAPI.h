...
///
class PhysxSchemaPhysxTendonAttachmentRootAPI : public PhysxSchemaPhysxTendonAttachmentAPI
{
public:
...
public:
    ...
    // STIFFNESS 
    // --------------------------------------------------------------------- //
    /// Common sub-tendon length spring stiffness. Range [0, inf).
...
public:
    ...
    // DAMPING 
    // --------------------------------------------------------------------- //
    /// Common sub-tendon length damping.  Range [0, inf).
...
public:
    ...
    // LIMITSTIFFNESS 
    // --------------------------------------------------------------------- //
    /// Common sub-tendon length-limit spring stiffness. Range [0, inf).
    /// Units: force / distance = mass / time / time
    ///
    /// | ||
    /// | -- | -- |
...
public:
    ...
    // OFFSET 
    // --------------------------------------------------------------------- //
    /// Common sub-tendon length offset. Range (-inf, inf).
    /// Units: distance
    ///
    /// | ||
    /// | -- | -- |

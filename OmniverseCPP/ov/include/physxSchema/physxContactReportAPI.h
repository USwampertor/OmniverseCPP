...
//
#ifndef PHYSXSCHEMA_GENERATED_PHYSXCONTACTREPORTAPI_H
#define PHYSXSCHEMA_GENERATED_PHYSXCONTACTREPORTAPI_H
...
public:
    ...
    /// an invalid \p prim
    explicit PhysxSchemaPhysxContactReportAPI(const UsdPrim& prim=UsdPrim())
    ...
    explicit PhysxSchemaPhysxContactReportAPI(const UsdSchemaBase& schemaObj)
    ...
    ///
    PHYSXSCHEMA_API
    static PhysxSchemaPhysxContactReportAPI

...
public:
    ...
    /// | ||
    /// | -- | -- |
    /// | Declaration | `float physxVehicleEngine:peakTorque` |
    /// | C++ Type | float |
    /// | \ref Usd_Datatypes "Usd Type" | SdfValueTypeNames->Float |
    PHYSXSCHEMA_API
...
public:
    ...
    // MAXROTATIONSPEED 
    // --------------------------------------------------------------------- //
    /// Maximum rotation speed of the engine (unit is radians per second [s^-1]). The value has to be positive.
    /// 
    /// Note: if not defined, the value 600.0 will be used.
    ///
    /// | ||
    /// | -- | -- |
    /// | Declaration | `float physxVehicleEngine:maxRotationSpeed` |
    /// | C++ Type | float |
    /// | \ref Usd_Datatypes "Usd Type" | SdfValueTypeNames->Float |
    PHYSXSCHEMA_API
...
public:
    ...
    // --------------------------------------------------------------------- //
    /// Damping rate of engine when full throttle is applied (default unit is 
    ...
    /// | ||
    /// | -- | -- |
    /// | Declaration | `float physxVehicleEngine:dampingRateFullThrottle` |
    /// | C++ Type | float |
    /// | \ref Usd_Datatypes "Usd Type" | SdfValueTypeNames->Float |
    PHYSXSCHEMA_API
...
public:
    ...
    // DAMPINGRATEZEROTHROTTLECLUTCHENGAGED 
    // --------------------------------------------------------------------- //
    /// Damping rate of engine when not throttle is applied and the clutch is engaged (default 
    ...
    /// | ||
    /// | -- | -- |
    /// | Declaration | `float physxVehicleEngine:dampingRateZeroThrottleClutchEngaged` |
    /// | C++ Type | float |
    /// | \ref Usd_Datatypes "Usd Type" | SdfValueTypeNames->Float |
    PHYSXSCHEMA_API
...
public:
    ...
    // DAMPINGRATEZEROTHROTTLECLUTCHDISENGAGED 
    // --------------------------------------------------------------------- //
    /// Damping rate of engine when not throttle is applied and the clutch is disengaged (default 
    /// unit is kilograms meters-squared per second [kg m^2 s^-1]). See attribute "dampingRateFullThrottle"
    /// for information about the effect of the value. The value has to be positive.
    /// 
    ...
    /// | ||
    /// | -- | -- |
    /// | Declaration | `float physxVehicleEngine:dampingRateZeroThrottleClutchDisengaged` |
    /// | C++ Type | float |
    /// | \ref Usd_Datatypes "Usd Type" | SdfValueTypeNames->Float |
    PHYSXSCHEMA_API

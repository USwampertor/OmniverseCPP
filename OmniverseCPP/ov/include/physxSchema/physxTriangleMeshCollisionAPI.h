...
//
#ifndef PHYSXSCHEMA_GENERATED_PHYSXTRIANGLEMESHCOLLISIONAPI_H
#define PHYSXSCHEMA_GENERATED_PHYSXTRIANGLEMESHCOLLISIONAPI_H
...
public:
    ...
    /// an invalid \p prim
    explicit PhysxSchemaPhysxTriangleMeshCollisionAPI(const UsdPrim& prim=UsdPrim())
    ...
    explicit PhysxSchemaPhysxTriangleMeshCollisionAPI(const UsdSchemaBase& schemaObj)
    ...
    ///
    PHYSXSCHEMA_API
    static PhysxSchemaPhysxTriangleMeshCollisionAPI

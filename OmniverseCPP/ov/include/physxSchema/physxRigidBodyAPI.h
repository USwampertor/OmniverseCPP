...
public:
    ...
    // LINEARDAMPING 
    // --------------------------------------------------------------------- //
    /// Linear damping coefficient. Allowed range [0, max_float).
    ///
    /// | ||
    /// | -- | -- |
...
public:
    ...
    // ANGULARDAMPING 
    // --------------------------------------------------------------------- //
    /// Angular damping coefficient. Allowed range [0, max_float).
    ///
    /// | ||
    /// | -- | -- |
...
public:
    ...
    // MAXLINEARVELOCITY 
    // --------------------------------------------------------------------- //
    /// Max allowable linear velocity for rigid body. Allowed range [0, inf).
    ///
    /// | ||
    /// | -- | -- |
...
public:
    ...
    // MAXANGULARVELOCITY 
    // --------------------------------------------------------------------- //
    /// Max allowable angular velocity for rigid body. Allowed range [0, 1e16].
    ///
    /// | ||
    /// | -- | -- |
...
public:
    ...
    // SLEEPTHRESHOLD 
    // --------------------------------------------------------------------- //
    /// Mass-normalized kinetic energy threshold below which an actor may go to sleep. Allowed range [0, max_float). Default value 0.00005*tolerancesSpeed*tolerancesSpeed.
    ///
    /// | ||
    /// | -- | -- |
...
public:
    ...
    // --------------------------------------------------------------------- //
    /// Mass-normalized kinetic energy threshold below which an actor may participate in stabilization. Allowed range [0, max_float). Default value 0.00001*tolerancesSpeed*tolerancesSpeed.
    ///
    /// | ||
    /// | -- | -- |
...
public:
    ...
    // --------------------------------------------------------------------- //
    /// The maximum depenetration velocity permitted to be introduced by the solver. Allowed range [0, max_float).
    ///
    /// | ||
    /// | -- | -- |
    /// | Declaration | `float physxRigidBody:maxDepenetrationVelocity = inf` |
    /// | C++ Type | float |
    /// | \ref Usd_Datatypes "Usd Type" | SdfValueTypeNames->Float |
    PHYSXSCHEMA_API

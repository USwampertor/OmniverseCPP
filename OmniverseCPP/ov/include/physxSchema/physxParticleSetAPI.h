...
//
#ifndef PHYSXSCHEMA_GENERATED_PHYSXPARTICLESETAPI_H
#define PHYSXSCHEMA_GENERATED_PHYSXPARTICLESETAPI_H
...
///
/// Applied to a UsdGeomPointInstancer or a UsdGeomPointBased. Creates a set of particles for granular material or fluid simulation with PhysX.
///
class PhysxSchemaPhysxParticleSetAPI : public PhysxSchemaPhysxParticleAPI
{
public:
    ...
    /// an invalid \p prim
    explicit PhysxSchemaPhysxParticleSetAPI(const UsdPrim& prim=UsdPrim())
        : PhysxSchemaPhysxParticleAPI(prim)
    {
    }
    ...
    explicit PhysxSchemaPhysxParticleSetAPI(const UsdSchemaBase& schemaObj)
        : PhysxSchemaPhysxParticleAPI(schemaObj)
    {
    }
    ...
    ///
    PHYSXSCHEMA_API
    static PhysxSchemaPhysxParticleSetAPI

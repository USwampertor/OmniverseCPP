...
//
#ifndef PXR_IMAGING_HD_ST_DRAW_TARGET_ATTACHMENT_DESC_ARRAY_H
#define PXR_IMAGING_HD_ST_DRAW_TARGET_ATTACHMENT_DESC_ARRAY_H
...
#endif  // PXR_IMAGING_HD_ST_DRAW_TARGET_ATTACHMENT_DESC_ARRAY_H

...
public:
    ...
    /// on \p camera . This operation will fail if there is an xformOpOrder
    /// opinion containing xformOp:transform in the composed layer stack that
    /// is stronger than that of the current edit target.
    ///
    USDGEOM_API

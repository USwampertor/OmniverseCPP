...
//
#ifndef FORCEFIELDSCHEMA_GENERATED_PHYSXFORCEFIELDSPHERICALAPI_H
#define FORCEFIELDSCHEMA_GENERATED_PHYSXFORCEFIELDSPHERICALAPI_H
...
///
class ForceFieldSchemaPhysxForceFieldSphericalAPI : public ForceFieldSchemaPhysxForceFieldAPI
{
public:
    ...
    /// an invalid \p prim
    explicit ForceFieldSchemaPhysxForceFieldSphericalAPI(
    ...
    /// Return a ForceFieldSchemaPhysxForceFieldSphericalAPI holding the prim adhering to this
    ...
    ///
    FORCEFIELDSCHEMA_API
    static ForceFieldSchemaPhysxForceFieldSphericalAPI
    Get(const UsdStagePtr &stage, const SdfPath &path);

    /// Return a ForceFieldSchemaPhysxForceFieldSphericalAPI with name \p name holding the
    /// prim \p prim. Shorthand for ForceFieldSchemaPhysxForceFieldSphericalAPI(prim, name);
    FORCEFIELDSCHEMA_API
    static ForceFieldSchemaPhysxForceFieldSphericalAPI
    Get(const UsdPrim &prim, const TfToken &name);

    /// Checks if the given name \p baseName is the base name of a property
    /// of PhysxForceFieldSphericalAPI.
    FORCEFIELDSCHEMA_API
    static bool
    IsSchemaPropertyBaseName(const TfToken &baseName);

    /// Checks if the given path \p path is of an API schema of type
    /// PhysxForceFieldSphericalAPI. If so, it stores the instance name of
    /// the schema in \p name and returns true. Otherwise, it returns false.
    FORCEFIELDSCHEMA_API
    static bool
    IsPhysxForceFieldSphericalAPIPath(const SdfPath &path, TfToken *name);

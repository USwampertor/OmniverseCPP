...
//
#ifndef FORCEFIELDSCHEMA_GENERATED_PHYSXFORCEFIELDPLANARAPI_H
#define FORCEFIELDSCHEMA_GENERATED_PHYSXFORCEFIELDPLANARAPI_H
...
/// point on the plane.
///
class ForceFieldSchemaPhysxForceFieldPlanarAPI : public ForceFieldSchemaPhysxForceFieldAPI
{
public:
    ...
    /// an invalid \p prim
    explicit ForceFieldSchemaPhysxForceFieldPlanarAPI(
    ...
    /// Return a ForceFieldSchemaPhysxForceFieldPlanarAPI holding the prim adhering to this
    ...
    ///
    FORCEFIELDSCHEMA_API
    static ForceFieldSchemaPhysxForceFieldPlanarAPI
    Get(const UsdStagePtr &stage, const SdfPath &path);

    /// Return a ForceFieldSchemaPhysxForceFieldPlanarAPI with name \p name holding the
    /// prim \p prim. Shorthand for ForceFieldSchemaPhysxForceFieldPlanarAPI(prim, name);
    FORCEFIELDSCHEMA_API
    static ForceFieldSchemaPhysxForceFieldPlanarAPI
    Get(const UsdPrim &prim, const TfToken &name);

    /// Checks if the given name \p baseName is the base name of a property
    /// of PhysxForceFieldPlanarAPI.
    FORCEFIELDSCHEMA_API
    static bool
    IsSchemaPropertyBaseName(const TfToken &baseName);

    /// Checks if the given path \p path is of an API schema of type
    /// PhysxForceFieldPlanarAPI. If so, it stores the instance name of
    /// the schema in \p name and returns true. Otherwise, it returns false.
    FORCEFIELDSCHEMA_API
    static bool
    IsPhysxForceFieldPlanarAPIPath(const SdfPath &path, TfToken *name);

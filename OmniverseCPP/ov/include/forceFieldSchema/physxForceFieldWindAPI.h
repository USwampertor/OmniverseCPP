...
//
#ifndef FORCEFIELDSCHEMA_GENERATED_PHYSXFORCEFIELDWINDAPI_H
#define FORCEFIELDSCHEMA_GENERATED_PHYSXFORCEFIELDWINDAPI_H
...
///
class ForceFieldSchemaPhysxForceFieldWindAPI : public ForceFieldSchemaPhysxForceFieldAPI
{
public:
    ...
    /// an invalid \p prim
    explicit ForceFieldSchemaPhysxForceFieldWindAPI(
    ...
    /// Return a ForceFieldSchemaPhysxForceFieldWindAPI holding the prim adhering to this
    ...
    ///
    FORCEFIELDSCHEMA_API
    static ForceFieldSchemaPhysxForceFieldWindAPI
    Get(const UsdStagePtr &stage, const SdfPath &path);

    /// Return a ForceFieldSchemaPhysxForceFieldWindAPI with name \p name holding the
    /// prim \p prim. Shorthand for ForceFieldSchemaPhysxForceFieldWindAPI(prim, name);
    FORCEFIELDSCHEMA_API
    static ForceFieldSchemaPhysxForceFieldWindAPI
    Get(const UsdPrim &prim, const TfToken &name);

    /// Checks if the given name \p baseName is the base name of a property
    /// of PhysxForceFieldWindAPI.
    FORCEFIELDSCHEMA_API
    static bool
    IsSchemaPropertyBaseName(const TfToken &baseName);

    /// Checks if the given path \p path is of an API schema of type
    /// PhysxForceFieldWindAPI. If so, it stores the instance name of
    /// the schema in \p name and returns true. Otherwise, it returns false.
    FORCEFIELDSCHEMA_API
    static bool
    IsPhysxForceFieldWindAPIPath(const SdfPath &path, TfToken *name);
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    FORCEFIELDSCHEMA_API
    UsdAttribute CreateAverageSpeedAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    FORCEFIELDSCHEMA_API
    UsdAttribute CreateAverageDirectionAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    FORCEFIELDSCHEMA_API
    UsdAttribute CreateSpeedVariationAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    FORCEFIELDSCHEMA_API
    UsdAttribute CreateSpeedVariationFrequencyAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    FORCEFIELDSCHEMA_API
    UsdAttribute CreateDirectionVariationAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// the default for \p writeSparsely is \c false.
    FORCEFIELDSCHEMA_API
    UsdAttribute CreateDirectionVariationFrequencyAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;

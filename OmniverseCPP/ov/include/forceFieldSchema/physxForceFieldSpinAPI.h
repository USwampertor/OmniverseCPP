...
//
#ifndef FORCEFIELDSCHEMA_GENERATED_PHYSXFORCEFIELDSPINAPI_H
#define FORCEFIELDSCHEMA_GENERATED_PHYSXFORCEFIELDSPINAPI_H
...
///
class ForceFieldSchemaPhysxForceFieldSpinAPI : public ForceFieldSchemaPhysxForceFieldAPI
{
public:
    ...
    /// an invalid \p prim
    explicit ForceFieldSchemaPhysxForceFieldSpinAPI(
    ...
    /// Return a ForceFieldSchemaPhysxForceFieldSpinAPI holding the prim adhering to this
    ...
    ///
    FORCEFIELDSCHEMA_API
    static ForceFieldSchemaPhysxForceFieldSpinAPI
    Get(const UsdStagePtr &stage, const SdfPath &path);

    /// Return a ForceFieldSchemaPhysxForceFieldSpinAPI with name \p name holding the
    /// prim \p prim. Shorthand for ForceFieldSchemaPhysxForceFieldSpinAPI(prim, name);
    FORCEFIELDSCHEMA_API
    static ForceFieldSchemaPhysxForceFieldSpinAPI
    Get(const UsdPrim &prim, const TfToken &name);

    /// Checks if the given name \p baseName is the base name of a property
    /// of PhysxForceFieldSpinAPI.
    FORCEFIELDSCHEMA_API
    static bool
    IsSchemaPropertyBaseName(const TfToken &baseName);

    /// Checks if the given path \p path is of an API schema of type
    /// PhysxForceFieldSpinAPI. If so, it stores the instance name of
    /// the schema in \p name and returns true. Otherwise, it returns false.
    FORCEFIELDSCHEMA_API
    static bool
    IsPhysxForceFieldSpinAPIPath(const SdfPath &path, TfToken *name);
...
public:
    ...
    FORCEFIELDSCHEMA_API
    UsdAttribute CreateSpinAxisAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
